...
Quarto allows for [easy cross-references of images and plots](https://quarto.org/docs/authoring/cross-references.html#figures). @fig-wearable shows an image, whereas @fig-plot shows a plot created using ggplot2.

![This is a picture of the wearable computing group from MIT. The wearable computing group appears to have mastery over the so-called "Rizz."](mit_wearable.jpeg){#fig-wearable fig-align="center"}
...
> Hi! My name is Ben. One of my favorite academic books is @bruckman2022. @bcr2016 is the last thing I read. The next thing I plan on reading is Nate Matias's social norms article [@matias2019].
